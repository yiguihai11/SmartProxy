...
//
//	go build -ldflags "-X smartproxy/internal/version.Version=1.1 \
...
var (
	// Version is the release version, two-digit x.y, normally derived from a
	// git tag (e.g. "1.2"). make build injects it automatically.
	Version = "1.0"
...
//
//	smartproxy 1.2 (commit abc1234, built 2026-08-05T12:00:00Z, go1.25.0)
func String() string {
