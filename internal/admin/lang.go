...
var zhStrings = map[string]string{
	...
	"Lantern Shared (Disabled)": "Lantern 共享节点（已停用）",
	"Subscription is disabled. Click Enable to activate nodes.": "订阅已停用。点击“启用”加载节点。",
	"Subscription has no nodes. Click Refresh to fetch nodes.":  "订阅暂无可用节点。点击“刷新”获取节点。",
	"Disable this subscription":                                 "停用此订阅",
	"Enable this subscription":                                  "启用此订阅",
	"Disabled":                                                  "已停用",
	"Collapse":                                                  "折叠",
	"Expand":                                                    "展开",
	"IP Address & Access Check":                                 "IP 地址与连通性检测",
	"IP Address":                                                "IP 地址",
	"Access Check":                                              "连通性检测",
	"PConline (Domestic)":                                       "PConline（国内）",
	"IPIP.NET (Domestic)":                                       "IPIP.NET（国内）",
	"IP.SB (Overseas)":                                          "IP.SB（国外）",
	"IPIFY (Overseas)":                                          "IPIFY（国外）",
	"Baidu Search":                                              "百度搜索",
	"NetEase Music":                                             "网易云音乐",
	"Hide IP":                                                   "隐藏 IP",
	"Show IP":                                                   "显示 IP",
	...
	"Details":                                                   "详情",
	"Node Details":                                              "节点详情",
	"Enter alias to save as custom node:":                       "输入保存为自定义节点的别名：",
	"Saved \"{0}\" as custom node":                              "已成功将「{0}」存为自定义节点",
	"Refresh":                                                   "刷新",
	"Refreshing...":                                             "刷新中…",
	"Refresh Lantern nodes now":                                 "立即刷新获取 Lantern 节点",
	"Successfully refreshed {0} Lantern nodes":                  "已成功刷新 {0} 个 Lantern 节点",
	"Lantern provider enabled":                                  "Lantern 共享池已启用",
	"Lantern provider disabled":                                 "Lantern 共享池已停用",
	"Fetching nodes from Lantern...":                            "正在从 Lantern 获取节点…",
	"Lantern shared pool is disabled. Click Enable to fetch free nodes.": "Lantern 共享池已停用。点击启用以获取免费节点。",
	"Copy Config":                   "复制配置",
	"Config Copied!":                "配置已复制！",
	"Raw Config":                    "原始配置",
	"Edit Raw Config":               "编辑原始配置",
	"+ Raw Config":                  "+ 原始配置",
	"Raw":                           "原始配置",
	"Edit and save as custom proxy": "编辑配置并存为自定义节点",
	"Add node via raw JSON or link": "通过原始 JSON 或链接添加节点",
	"Format JSON":                   "格式化 JSON",
	"Compress JSON":                 "压缩为单行",
	"Formatted":                     "已格式化",
	"Compressed":                    "已压缩",
	"Supports sing-box JSON configuration or proxy URLs (vless://, hysteria2://, ss://, etc.)": "支持 sing-box JSON 格式配置或标准代理链接（vless://, hysteria2://, ss:// 等）",
	"Config Content (JSON / URL)": "配置内容（JSON / 链接）",
	"Invalid JSON":                "JSON 语法错误",
	"Save as Custom":              "保存为自定义节点",
	"Save Changes":                "保存修改",
	"Config content is required":  "配置内容不能为空",
	"Node saved successfully!":    "节点已成功保存！",
	"Protocol":                    "协议",
	"Method":                      "加密方法",
	"Password / Key":              "密码 / 密钥",
	"Provider":                    "节点来源",
	...
	"Subscription Type":  "订阅格式",
	"Auto-detect (SIP008 / Base64 / sing-box / Clash)":      "自动检测 (SIP008 / Base64 / sing-box / Clash)",
	"SIP008 (Shadowsocks JSON)":                             "SIP008 (Shadowsocks JSON)",
	"Base64 / Proxy Links":                                  "通用 Base64 / 节点链接",
	"sing-box (Outbounds JSON)":                             "sing-box (Outbounds JSON)",
	"Clash (YAML)":                                          "Clash (YAML)",
	"Update Interval":                                       "更新周期",
	"Fetch via proxy node (remote DNS)":                     "通过节点代理拉取（远端解析 DNS）",
	"Refresh Subscription":                                  "立即刷新订阅",
	"Refreshing subscription...":                            "正在刷新订阅…",
	"Successfully refreshed {0} subscription nodes":         "已成功刷新 {0} 个订阅节点",
	"Subscription saved successfully!":                      "订阅已成功保存！",
	"Delete Subscription":                                   "删除订阅",
	"Are you sure you want to delete subscription \"{0}\"?": "确定要删除订阅「{0}」吗？",
	"Subscription deleted":                                  "订阅已删除",
	"Subscription enabled":                                  "订阅已启用",
	...
	"Line {0}":                                        "第 {0} 行",
	"🗑️ Delete these rules":                           "🗑️ 直接删除这些规则",
	"Delete Rules":                                    "删除规则",
	"Delete All Invalid Rules":                        "一键删除所有失效规则",
	"Are you sure you want to delete all rules pointing to invalid proxies?":     "确定要删除所有指向失效代理的 ACL 规则吗？",
	"Please select an action (replace or delete) for at least one invalid alias": "请至少为一个失效节点选择处理方式（替换或删除）",
	"Successfully processed ACL rules: {0}":                                      "已成功处理 ACL 规则：{0}",
	"{0} updated":                                                                "已替换 {0} 条",
	"{0} deleted":                                                                "已删除 {0} 条",
	...
	"Test TCPing latency":                     "测试直连 TCPing 延迟",
...
var zhDynamicKeys = map[string]bool{
	...
	"Test TCPing latency":                    true,
	"Test TCP latency and availability":      true,
	"Test UDP latency and availability":      true,
	"Test All TCPing":                        true,
	"Test All TCP":                           true,
	"Test All UDP":                           true,
	"Test All":                               true,
	"No proxy nodes to test":                 true,
	"Edit Subscription":                      true,
	"Refresh Subscription":                   true,
	"Refreshing subscription...":             true,
	"Subscription saved successfully!":       true,
