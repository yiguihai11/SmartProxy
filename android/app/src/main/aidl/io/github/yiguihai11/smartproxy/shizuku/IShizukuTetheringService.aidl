...
interface IShizukuTetheringService {
    ...
    int startRouting(String profileName, in String[] dnsServers, boolean ipv6Enabled, String syncToken, ICoreTetheringLease coreLease) = 6;
    int stopRouting() = 7;
    int notifyCoreStopping(String syncToken) = 9;
    int synchronizeRouting(String syncToken, String profileName, in String[] dnsServers, boolean ipv6Enabled, ICoreTetheringLease coreLease) = 10;
